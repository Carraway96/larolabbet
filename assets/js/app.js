(function () {
  ...
  const subjectPalette = {
    samhallskunskap: { accent: '#d59bcf', soft: '#f6e8f4', button: '#8b4d88' },
    religion: { accent: '#d8bc72', soft: '#f8f0d9', button: '#8c6a24' },
    historia: { accent: '#d5a58e', soft: '#f8ebe4', button: '#8f5c47' },
    geografi: { accent: '#8ecfc8', soft: '#e4f6f4', button: '#266f69' }
  };

  const getPalette = (subjectId) => subjectPalette[subjectId] || { accent: '#c9d7e7', soft: '#f8fafc', button: '#0f4c8a' };
